...
export class AllBooksComponent implements OnInit {
  displayedColumns = ['select', 'img', 'title', 'author', 'year', 'category'];
  exampleDatabase: BooksService | null;
  ...
  public loadData() {
    this.exampleDatabase = new BooksService(this.httpClient);
...
export class ExampleDataSource extends DataSource<Book> {
  ...
  renderedData: Book[] = [];
  constructor(
    public exampleDatabase: BooksService,
  ...
  connect(): Observable<Book[]> {
    ...
    this.exampleDatabase.getFakeBooks();
